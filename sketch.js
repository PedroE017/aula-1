...
class Bullet {
  ...
  draw() {
    ...
    fill(red(0, 256), green(0, 256), red(0, 256)); 
...
class Enemy {
  ...
  draw() {
    strokeWeight(2);
    stroke(255);
    line(this.posX+20, this.posY+random(25), this.posX+45, this.posY+10);
    strokeWeight(2); 
    stroke(255);
    line(this.posX+20, this.posY+random(25), this.posX, this.posY+10);
    this.posY++;
    strokeWeight(1); 
    fill(random(0, 256));
    circle(this.posX+20, this.posY+2, this.size);
    this.posY++;
    fill("random");random(0, 256),
...
function draw() {
  background("#051933");
  fill(random(0,256), blue(0,256), random(0,256))
